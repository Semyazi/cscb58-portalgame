...
text_surface = my_font.render('Fail...', False, COL_5)
screen.blit(text_surface, (16,0))
...
smilerect=pygame.Rect(20,33,width,height)
pygame.draw.arc(screen,COL_5,smilerect,0,-math.pi)

# thx for playin

#surf=lvl_font.render('Thx 4 playing :)',False,COL_5)
#screen.blit(surf,(0,53))
...
print(out)
out=out[:-1]
with open('./screens/fail.txt','w') as file:file.write(out)
